---
type: spec
title: Anonymous-PoW difficulty lives in the state
description: The publisher's PoW bar is latched into contract state from a signed cell rather than attached to each delta, so an attacker cannot omit or downgrade their way past a raise. Issues #51 to #65 to #66; includes the deliberate non-retroactive and per-owner-lazy limits.
timestamp: 2026-08-14T00:00:00Z
status: living
covers:
  - pow/**
  - contracts/directory-contract/**
...
dual-read window; see [the dual-read window](dual-read-window.md).
...
[reproducible builds](../policies/reproducible-builds.md) notes that Apple Silicon cannot produce the
